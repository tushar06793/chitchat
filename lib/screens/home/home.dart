...
import 'package:chitchat/screens/group/add_member.dart';

import 'package:chitchat/screens/home/chats.dart';
import 'package:chitchat/screens/home/group_chat_screen.dart';
        ...
        actions: [
          ...
          PopupMenuButton<String>(onSelected: (value) async {
            ...
            return [
              ...
              const PopupMenuItem(child: Text("Log out"), value: "Log out"),
            ];
          })
        ],
        bottom: TabBar(
